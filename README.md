# MusicBot: The Rotharia Guild's music Discord bot.

MusicBot is a Discord music bot written in [Python 3.6+](https://www.python.org "Python homepage"). It plays requested songs and if the queue becomes empty it will play through a list of existing songs.

### Who made it?

All credit goes to the fine folks that have contributed to [the original MusicBot](https://github.com/Just-Some-Bots/MusicBot). This project built on their hard work.
